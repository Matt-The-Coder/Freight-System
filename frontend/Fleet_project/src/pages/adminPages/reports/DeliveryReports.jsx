...
const DeliveryReports = ({ socket }) => {
  ...
  return (
    <>
                <Breadcrumbs title="Reports" subtitle="Deliveries" />
      <Sidebar/>
                                                ...
                                                <input
                                                    ...
                                                    onChange={async (el) => {
                                                        if (el.currentTarget.checked) {
                                                            ...
                                                            setFilter(el.currentTarget.value)
                                                            const filterReports = deliveryReportsStorage.filter((e, i) => {
                                                                return e.t_trip_status == "Pending"
                                                            })
                                                            setDeliveryReports(filterReports)
                                                ...
                                                <input
                                                    ...
                                                    onChange={async (el) => {
                                                        if (el.currentTarget.checked) {
                                                            ...
                                                            setFilter(el.currentTarget.value)
                                                            const filterReports = deliveryReportsStorage.filter((e, i) => {
                                                                return e.t_trip_status == "In Progress"
                                                            })
                                                            setDeliveryReports(filterReports)
                    ...
                    DeliveryReports.map((e, i) => {
                      return (
                        <tr key={i} className="hover:bg-gray-100 dark:hover:bg-neutral-700">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
                            {e?.t_remarks ? e.t_remarks : "N/A"}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
                            {e?.t_trackingcode}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
                            {formatDateTime(e.t_created_date)}
                          </td>
                        </tr>
                      )
                    })
