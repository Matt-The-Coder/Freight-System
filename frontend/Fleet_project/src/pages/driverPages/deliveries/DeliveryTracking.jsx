        ...
        {isMobile ?
          (<>
            <div className="switch-pager">
              <h4 onClick={switchPage}  className="py-3 px-4 inline-flex justify-center border-r-black gap-x-2 text-sm font-semibold rounded border border-transparent bg-primary_blue text-white hover:primary_hover disabled:opacity-50 disabled:pointer-events-none">Map Data</h4>
              <h4 onClick={switchPage} className="py-3 px-4 inline-flex justify-center gap-x-2 text-sm font-semibold rounded border border-transparent bg-primary_blue text-white hover:primary_hover disabled:opacity-50 disabled:pointer-events-none">Transit Data</h4>
            </div>
